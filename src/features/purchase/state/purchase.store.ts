...
interface PurchaseState {
  ...
  setPreviewItem: (item: PurchaseState['previewItem']) => void;
...
export const usePurchaseStore = create<PurchaseState>()((set, _get) => {
      ...
      removeItem: (id) => set((state) => ({
        draft: {
	      ...
	      setField: (path, value) => set((state) => {
	        ...
	        let current = newDraft as unknown as Record<string, unknown>;
