...
export const NAV_ITEMS: SidebarItem[] = [
  ...
  { id: 'purchase-supplier', label: '采购供应商', path: '/purchase-supplier', icon: Factory, permissionKey: 'canManagePurchaseSuppliers' },
...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    label: '管理',
    icon: Settings2,
    items: navGroupItems(['history', 'customer', 'purchase-supplier']),
  },
  {
    id: 'tools',
    label: '工具',
...
const PERMISSION_MODULE_MAP: Record<string, string> = {
  ...
  canManagePurchaseSuppliers: 'purchaseSupplier',
  canUseClock:          'clock',
