          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  仅导出当前显示的{activeTab === 'quotation' ? '报价单' : activeTab === 'confirmation' ? '销售确认' : activeTab === 'domestic' ? '内销报价' : activeTab === 'domestic-contract' ? '内销合同' : activeTab === 'invoice' ? '发票' : activeTab === 'purchase' ? '采购单' : '装箱单'}数据
                </div>
              </div>
            </div>
          </button>
