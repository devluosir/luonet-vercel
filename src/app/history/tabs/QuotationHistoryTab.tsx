...
export default function QuotationHistoryTab({ 
    ...
    try {
      ...
      if (sortConfig.key) {
        results = [...results].sort((a, b) => {
          const aValue = a[sortConfig.key as keyof QuotationHistory];
          const bValue = b[sortConfig.key as keyof QuotationHistory];
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className={`bg-gradient-to-r px-4 py-2 sm:py-4 border-b border-gray-200 dark:border-gray-600 ${
        ...
        <div className="flex items-center w-full">
          ...
          <button
            ...
            className="flex-1 min-w-0 truncate font-semibold pl-2 text-left hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center group whitespace-nowrap text-gray-900 dark:text-white"
          >
            客户名称
          ...
          <button
            ...
            className="md:flex w-36 flex-shrink-0 font-semibold pl-2 text-left hover:text-blue-600 dark:hover:text-blue-400 transition-colors items-center group whitespace-nowrap text-gray-900 dark:text-white hidden"
          >
            金额
          ...
          <button
            ...
            className="lg:flex w-40 flex-shrink-0 font-semibold pl-2 text-left hover:text-blue-600 dark:hover:text-blue-400 transition-colors items-center group whitespace-nowrap text-gray-900 dark:text-white hidden"
          >
            修改时间
          ...
          <button
            ...
            className="xl:flex w-40 flex-shrink-0 font-semibold pl-2 text-left hover:text-blue-600 dark:hover:text-blue-400 transition-colors items-center group whitespace-nowrap text-gray-900 dark:text-white hidden"
          >
            创建时间
      ...
      {/* 金额统计 */}
      {history.length > 0 && (
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/10 border-t border-blue-200 dark:border-blue-800 px-4 py-2 sm:py-3">
