      ...
      <div className={`bg-gradient-to-r px-4 py-2 sm:py-4 border-b border-gray-200 dark:border-gray-600 ${
        ...
        <div className="flex items-center w-full">
          ...
          <button
            ...
            className="md:flex w-36 flex-shrink-0 font-semibold pl-2 text-left hover:text-green-600 dark:hover:text-green-400 transition-colors items-center group whitespace-nowrap text-gray-900 dark:text-white hidden"
          >
            金额
          ...
          <button
            ...
            className="lg:flex w-40 flex-shrink-0 font-semibold pl-2 text-left hover:text-green-600 dark:hover:text-green-400 transition-colors items-center group whitespace-nowrap text-gray-900 dark:text-white hidden"
          >
            修改时间
          ...
          <button
            ...
            className="xl:flex w-40 flex-shrink-0 font-semibold pl-2 text-left hover:text-green-600 dark:hover:text-green-400 transition-colors items-center group whitespace-nowrap text-gray-900 dark:text-white hidden"
          >
            创建时间
