...
export default function InvoiceHistoryTab({ 
  ...
  return (
    <div className="overflow-hidden">
            ...
            >
              <div className="flex items-center w-full">
                ...
                <div className="w-24 sm:w-40 flex-shrink-0">
                  <div className="whitespace-nowrap text-xs sm:text-sm font-bold text-purple-600 dark:text-purple-400 font-mono">
                    {item.invoiceNo}
                  </div>
                </div>
      ...
      {/* 金额统计 */}
      {history.length > 0 && (
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border-t border-purple-200 dark:border-purple-800 px-4 py-2 sm:py-3">
